<div x-data="{ historyIndex: @entangle('historyIndex') }" x-init="$refs.terminalInput.focus()" x-on:click="$refs.terminalInput.focus()" class="h-screen w-screen border-solid p-1 sm:p-3">
    <div id="header" class="bg-gradient-to-b from-purple-500/40 bg-purple-300 rounded-t-sm h-11 p-2.5 text-base">
        jasonferenbach.com
    </div>
    ...
    <div class="hidden space-y-2 -mt-0.5 -mt-1 mt-3 text-gray-100 hover:text-gray-800 mr-2 underline items-center ml-4 h-4 w-4 text-xxxs sm:text-xxs w-36 space-y-4 from-orange-300 to-purple-500 text-red-300 hover:bg-orange-300 mt-3 mt-4 bg-gradient-to-t bg-clip-text text-transparent
